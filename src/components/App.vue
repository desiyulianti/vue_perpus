<template>
         <div>
            ...
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">My Perpus</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <router-link to="/home" class="nav-link">
                                ...
                                Book
                                 ...
                                 <router-link to="/borrowing" class="nav-link">
                                <div class="sb-nav-link-icon"><i class="bi bi-book-half"></i></div>
                                Book Borrowing
                                </router-link>
                                ...
                                <div class="sb-nav-link-icon"><i class="bi bi-nintendo-switch"></i></div>
                                Class
                                </router-link>
                        </div>
                    </div>
